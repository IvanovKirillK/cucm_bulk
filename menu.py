...
while True:
    ...
    if selection == '1':
        ...
        #TODO опираемся на справочник пользователей в текстовом файле!
        #TODO убрать 9 столбец из вхдных данных
        #TODO пустое имя пользователя ad - норм для первой итерации
